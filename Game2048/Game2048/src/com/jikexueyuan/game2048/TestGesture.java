...
public class TestGesture {
	...
	Hmm<ObservationVector> learntHmmSend=null;
	 String root = Environment.getExternalStorageDirectory().toString();
	    File myDir = new File(root + "/Bigdata");    
...
public void	train() {
    ...
    Reader learnReaderPunch = new FileReader(new File (myDir, "goup.seq"));
    ...
    Reader learnReaderScrolldown = new FileReader(new File (myDir, "goright.seq"));
    ...
    Reader learnReaderSend = new FileReader(new File (myDir, "goleft.seq"));
